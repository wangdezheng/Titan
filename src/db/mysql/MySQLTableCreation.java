...
//					+ "CONSTRAINT pk_category PRIMARY KEY(item_id, category)"
//					+ "CONSTRAINT fk_category FOREIGN KEY(item_id) REFEREMCES items(item_id))";
			...
			// Step 3: insert data
			// Create a fake user
			sql = "INSERT INTO users (user_id, password, first_name, last_name) " + "VALUES ('1111', '3229c1097c00d497a0fd282d586be050', 'John', 'Smith')";
			stmt.executeUpdate(sql);
